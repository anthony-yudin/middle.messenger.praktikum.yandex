...
class PopupAddUserChat extends Block {
  ...
  render(): string {
    return `
      <div class="popup popup_add-user-chat">
        <div class="popup__box">
          {{{ ButtonClose }}}

          <div class="popup__title">Добавить пользователя в чат</div>
...
export default PopupAddUserChat;